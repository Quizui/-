...
namespace SonikLib
{
	...
	public:
		...
		//コンストラクタオーバーロード
		SonikStringUTF16_pImpl(const utf8_t* SetStr);
		SonikStringUTF16_pImpl(const utf8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//コンストラクタオーバーロード
		...
		SonikStringUTF16_pImpl& operator =(const utf8_t* utf8_Str);
	...
	SonikStringUTF16::SonikStringUTF16_pImpl::SonikStringUTF16_pImpl(const utf8_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikStringUTF16::SonikStringUTF16_pImpl::SonikStringUTF16_pImpl(const utf8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
...
//		unsigned long bufsize_ = SonikLibStringConvert::GetStringLength(reinterpret_cast<char*>(Stringval_));
	...
	const utf8_t* SonikStringUTF16::SonikStringUTF16_pImpl::str_utf8(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
	...
	uint64_t SonikStringUTF16::SonikStringUTF16_pImpl::GetCpy_str_utf8(utf8_t* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	bool SonikStringUTF16::SonikStringUTF16_pImpl::SplitForUTF8(utf8_t delim, SonikLib::Container::SonikVariableArrayContainer<SonikLib::SonikStringUTF16>& Container)
	{
		this->str_utf8();
	...
	SonikStringUTF16::SonikStringUTF16_pImpl& SonikStringUTF16::SonikStringUTF16_pImpl::operator =(const utf8_t* utf8_Str)
	{
		if(utf8_Str == nullptr )
		{
			return (*this);
	...
	bool SonikStringUTF16::SonikStringUTF16_pImpl::operator ==(const utf8_t* utf8_Str)
	{
...
//===========================================================
	...
	//UTF8形式に変換して取得します。(バッファタイプも書き換わります。)
	const utf8_t* SonikStringUTF16::str_utf8(void)
	{
	...
	//UTF8形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikStringUTF16::GetCpy_str_utf8(utf8_t* dstBuffer)
	{
	...
	bool SonikStringUTF16::operator ==(const utf8_t* utf8_Str)
	{
