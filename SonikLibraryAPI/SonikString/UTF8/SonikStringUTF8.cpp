...
namespace SonikLib
{
	...
	public:
		//c:コンストラクタ
		SonikStringUTF8_pImpl(SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikStringUTF8_pImpl(const char* SetStr);
		SonikStringUTF8_pImpl(const char* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikStringUTF8_pImpl(const char16_t* SetStr);
		SonikStringUTF8_pImpl(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikStringUTF8_pImpl(const wchar_t* SetStr);
		SonikStringUTF8_pImpl(const wchar_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//コンストラクタオーバーロード
		SonikStringUTF8_pImpl(const char8_t* SetStr);
		SonikStringUTF8_pImpl(const char8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//コンストラクタオーバーロード
        SonikStringUTF8_pImpl(const int8_t SetValue);
		SonikStringUTF8_pImpl(const int8_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringUTF8_pImpl(const uint8_t SetValue);
		SonikStringUTF8_pImpl(const uint8_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringUTF8_pImpl(const int16_t SetValue);
		SonikStringUTF8_pImpl(const int16_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringUTF8_pImpl(const uint16_t SetValue);
		SonikStringUTF8_pImpl(const uint16_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringUTF8_pImpl(const int32_t SetValue);
		SonikStringUTF8_pImpl(const int32_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringUTF8_pImpl(const uint32_t SetValue);
		SonikStringUTF8_pImpl(const uint32_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringUTF8_pImpl(const int64_t SetValue);
		SonikStringUTF8_pImpl(const int64_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringUTF8_pImpl(const uint64_t SetValue);
		SonikStringUTF8_pImpl(const uint64_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringUTF8_pImpl(const float SetValue);
		SonikStringUTF8_pImpl(const float SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringUTF8_pImpl(const double SetValue);
		SonikStringUTF8_pImpl(const double SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);

		//c:コピーコンストラクタ
		SonikStringUTF8_pImpl(const SonikStringUTF8_pImpl& t_his);

		//c:デストラクタ
		~SonikStringUTF8_pImpl(void);
		...
		bool SplitForUTF8(char8_t delim, SonikLib::Container::SonikVariableArrayContainer<SonikLib::SonikStringUTF8>& Container);

		//c: 各入力フォーマットから現在のバッファに変換して代入します。
		SonikStringUTF8_pImpl& operator =(const SonikStringUTF8_pImpl& t_his);
		SonikStringUTF8_pImpl& operator =(SonikStringUTF8_pImpl&& Move) noexcept;
		SonikStringUTF8_pImpl& operator =(const char* Str);
		SonikStringUTF8_pImpl& operator =(const char16_t* w_Str);
		SonikStringUTF8_pImpl& operator =(const wchar_t* w_Str);
		SonikStringUTF8_pImpl& operator =(const char8_t* utf8_Str);
        SonikStringUTF8_pImpl& operator =(const int8_t SetValue);
        SonikStringUTF8_pImpl& operator =(const uint8_t SetValue);
        SonikStringUTF8_pImpl& operator =(const int16_t SetValue);
        SonikStringUTF8_pImpl& operator =(const uint16_t SetValue);
        SonikStringUTF8_pImpl& operator =(const int32_t SetValue);
        SonikStringUTF8_pImpl& operator =(const uint32_t SetValue);
        SonikStringUTF8_pImpl& operator =(const int64_t SetValue);
        SonikStringUTF8_pImpl& operator =(const uint64_t SetValue);
        SonikStringUTF8_pImpl& operator =(const float SetValue);
		SonikStringUTF8_pImpl& operator =(const double SetValue);
		...
		bool operator ==(const SonikStringUTF8_pImpl& t_his) ;
	...
	SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	...
	SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const char* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
	...
	SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const char* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
	...
	SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const char16_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const wchar_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	...
	SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const wchar_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UNKNOWN)
	...
	SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const char8_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const char8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const int8_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const int8_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const uint8_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const uint8_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const int16_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const int16_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const uint16_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const uint16_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const int32_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const int32_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const uint32_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const uint32_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const int64_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const int64_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const uint64_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const uint64_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const float SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const float SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const double SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const double SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
	...
	SonikStringUTF8::SonikStringUTF8_pImpl::SonikStringUTF8_pImpl(const SonikStringUTF8_pImpl& t_his)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikStringUTF8::SonikStringUTF8_pImpl::~SonikStringUTF8_pImpl(void)
	{
		if(m_locale != 0)
		{
			delete[] m_locale;
	...
	bool SonikStringUTF8::SonikStringUTF8_pImpl::SetCharacterType(SonikLibConvertType SetType)
	{
...
//		unsigned long bufsize_ = SonikLibStringConvert::GetStringLength(reinterpret_cast<char*>(Stringval_));
	...
	bool SonikStringUTF8::SonikStringUTF8_pImpl::ReAlloc(uint64_t ReArraySize)
	{
		char8_t* pTmp = 0;
	...
	//ロケールを設定します。
	bool SonikStringUTF8::SonikStringUTF8_pImpl::SetStringLocale(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
	...
	const char* SonikStringUTF8::SonikStringUTF8_pImpl::str_c(void)
	{
	...
	//wchar_t形式に変換して取得します。(バッファタイプも書き換わります。)
	const wchar_t* SonikStringUTF8::SonikStringUTF8_pImpl::str_wchar(void)
	{
		if( CType == SCHTYPE_UNKNOWN )
		{
			return L"";
	...
	const char16_t* SonikStringUTF8::SonikStringUTF8_pImpl::str_utf16(void)
	{
		if( CType == SCHTYPE_UNKNOWN )
		{
			return u"";
	...
	const char8_t* SonikStringUTF8::SonikStringUTF8_pImpl::str_utf8(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
	...
	uint64_t SonikStringUTF8::SonikStringUTF8_pImpl::GetCpy_str_c(char* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikStringUTF8::SonikStringUTF8_pImpl::GetCpy_str_wcstr(wchar_t* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikStringUTF8::SonikStringUTF8_pImpl::GetCpy_str_utf16(char16_t* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikStringUTF8::SonikStringUTF8_pImpl::GetCpy_str_utf8(char8_t* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	//c:文字列のByte数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikStringUTF8::SonikStringUTF8_pImpl::Count_Byte_NotNull(void)
	{
		return SonikLibStringConvert::GetStringLengthByte(reinterpret_cast<char*>(Stringval_));
	};

	//c:文字列数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikStringUTF8::SonikStringUTF8_pImpl::Count_Str_NotNull(void)
	{
		return MaxLength_;
	};

	//文字列中の全角英数字を半角英数字に変換します。
	bool SonikStringUTF8::SonikStringUTF8_pImpl::ConvertFWANtoHWAN(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return false;
	...
	bool SonikStringUTF8::SonikStringUTF8_pImpl::ConvertFWKNtoHWKN(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return false;
	...
	//c: 指定位置の文字を削除します。
	void SonikStringUTF8::SonikStringUTF8_pImpl::EraseChar(uint64_t ChrPoint)
	{
		this->str_utf8();
	...
	//c: 指定の開始位置から指定された文字数を削除します。
	void SonikStringUTF8::SonikStringUTF8_pImpl::EraseStr(uint64_t ChrStartPoint, uint64_t ChrEndPoint)
	{
		this->str_utf8();
	...
	bool SonikStringUTF8::SonikStringUTF8_pImpl::SplitForUTF8(char8_t delim, SonikLib::Container::SonikVariableArrayContainer<SonikLib::SonikStringUTF8>& Container)
	{
		this->str_utf8();
	...
	SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const SonikStringUTF8_pImpl& t_his)
	{
	...
	SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(SonikStringUTF8_pImpl&& Move) noexcept
	{
		if( this == &Move )
		{
			return (*this);
	...
	SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const char* Str)
	{
		if(Str == 0 )
		{
			return (*this);
	...
	SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const char16_t* w_Str)
	{
		if(w_Str == 0 )
		{
			return (*this);
	...
	SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const wchar_t* w_Str)
	{
		if(w_Str == 0 )
		{
			return (*this);
	...
	SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const char8_t* utf8_Str)
	{
		if(utf8_Str == nullptr )
		{
			return (*this);
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const int8_t SetValue)
	{
		string_operator_lock.lock();
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const uint8_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const int16_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const uint16_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const int32_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const uint32_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const int64_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const uint64_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const float SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringUTF8::SonikStringUTF8_pImpl& SonikStringUTF8::SonikStringUTF8_pImpl::operator =(const double SetValue)
    {
		string_operator_lock.lock();
	...
	SonikStringUTF8::SonikStringUTF8_pImpl SonikStringUTF8::SonikStringUTF8_pImpl::operator +(const SonikStringUTF8_pImpl& t_his)
	{
		SonikStringUTF8_pImpl tmpStr = (*this);
	...
	//c: 文字列同士を比較します。(strcmp)
	//c: 一致の場合true 不一致の場合 falseを返却します。
	bool SonikStringUTF8::SonikStringUTF8_pImpl::operator ==(const SonikStringUTF8_pImpl& t_his)
	{
	...
	bool SonikStringUTF8::SonikStringUTF8_pImpl::operator ==(const char* Str)
	{
	...
	bool SonikStringUTF8::SonikStringUTF8_pImpl::operator ==(const char16_t* w_Str)
	{
		//c: 文字タイプが違えば相手と同じ文字タイプに変換
		if( CType != SCHTYPE_UTF16 )
		{
	...
	bool SonikStringUTF8::SonikStringUTF8_pImpl::operator ==(const wchar_t* w_Str)
	{
#if WCHAR_MAX <= 0xFFFFU
		uint32_t NULLSTR_SIZE = 2;
		using CONST_CHRTYPE = const char16_t*;
	...
	bool SonikStringUTF8::SonikStringUTF8_pImpl::operator ==(const char8_t* utf8_Str)
	{
	...
	//c:比較演算子
	bool SonikStringUTF8::SonikStringUTF8_pImpl::Greater(const char* CompareArg2val)
	{
		return strcmp(this->str_c(), CompareArg2val) > 0;
	};

	bool SonikStringUTF8::SonikStringUTF8_pImpl::Less(const char* CompareArg2val)
	{
		return strcmp(this->str_c(), CompareArg2val) < 0;
	};

	bool SonikStringUTF8::SonikStringUTF8_pImpl::GreaterEqual(const char* CompareArg2val)
	{
		return !(this->Less(CompareArg2val));
	};

	bool SonikStringUTF8::SonikStringUTF8_pImpl::LessEqual(const char* CompareArg2val)
	{
...
//===========================================================
	...
	SonikStringUTF8::SonikStringUTF8(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		...
		try
		{
			pImpl = new SonikStringUTF8_pImpl(_setlocale_);
		}catch(std::bad_alloc&)
		{
			delete pImpl;
			throw;
	...
	SonikStringUTF8::SonikStringUTF8(const SonikStringUTF8& t_his)
	{
		...
		try
		{
			pImpl = new SonikStringUTF8_pImpl(SonikLibStringConvert::SonikLibConvertLocale::LC_JPN);
			(*pImpl) = (*(t_his.pImpl));
		}catch(std::bad_alloc&)
		{
			delete pImpl;
	...
	SonikStringUTF8::SonikStringUTF8(const char8_t* SetStr)
	{
		pImpl = 0;
	...
	SonikStringUTF8::SonikStringUTF8(const char8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;
	...
	//ロケールを設定します。
	bool SonikStringUTF8::SetStringLocale(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		return pImpl->SetStringLocale(_setlocale_);
	};

	//SJIS形式に変換して取得します。(バッファタイプも書き換わります。)
	const char* SonikStringUTF8::str_c(void)
	{
		return pImpl->str_c();
	};

	//wchar_t形式に変換して取得します。(バッファタイプも書き換わります。)
	const wchar_t* SonikStringUTF8::str_wchar(void)
	{
		return pImpl->str_wchar();
	};

	//UTF16形式に変換して取得します。(バッファタイプも書き換わります。)
	const char16_t* SonikStringUTF8::str_utf16(void)
	{
		return pImpl->str_utf16();
	};

	//UTF8形式に変換して取得します。(バッファタイプも書き換わります。)
	const char8_t* SonikStringUTF8::str_utf8(void)
	{
		return pImpl->str_utf8();
	};

	//define切り替えのstrゲット
	const char8_t* SonikStringUTF8::definition_str(void)
	{
		return pImpl->str_utf8();
	};
	...
	//SJIS形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikStringUTF8::GetCpy_str_c(char* dstBuffer)
	{
	...
	//wchar_t形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikStringUTF8::GetCpy_str_wcstr(wchar_t* dstBuffer)
	{
	...
	//UTF16形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikStringUTF8::GetCpy_str_utf16(char16_t* dstBuffer)
	{
	...
	//UTF8形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikStringUTF8::GetCpy_str_utf8(char8_t* dstBuffer)
	{
		return pImpl->GetCpy_str_utf8(dstBuffer);
	};

	//define切り替えのStrCopy
	uint64_t SonikStringUTF8::GetCpy_str_definition(char8_t* dstBuffer)
	{
		return pImpl->GetCpy_str_utf8(dstBuffer);
	};

	//c:文字列のByte数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikStringUTF8::Count_Byte_NotNull(void)
	{
		return pImpl->Count_Byte_NotNull();
	};

	//c:文字列数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikStringUTF8::Count_Str_NotNull(void)
	{
		return pImpl->Count_Str_NotNull();
	};

	//文字列中の全角英数字を半角英数字に変換します。
	bool SonikStringUTF8::ConvertFWANtoHWAN(void)
	{
		return pImpl->ConvertFWANtoHWAN();
	};

	//文字列中の全角カナを半角カナに変換します。
	bool SonikStringUTF8::ConvertFWKNtoHWKN(void)
	{
		return pImpl->ConvertFWKNtoHWKN();
	};

	//c: 指定位置の文字を削除します。
	void SonikStringUTF8::EraseChar(uint64_t ChrPoint)
	{
		pImpl->EraseChar(ChrPoint);
	};

	//c: 指定の開始位置から指定された文字数を削除します。
	void SonikStringUTF8::EraseStr(uint64_t ChrStartPoint, uint64_t ChrEndPoint)
	{
	...
	SonikStringUTF8& SonikStringUTF8::operator =(const char8_t* utf8_Str)
	{
		(*pImpl) = utf8_Str;
	...
	//c: 文字列同士を比較します。(strcmp)
	//c: 一致の場合true 不一致の場合 falseを返却します。
	bool SonikStringUTF8::operator ==(const SonikStringUTF8& t_his)
	{
		return (*pImpl) == (*t_his.pImpl);
	};

	bool SonikStringUTF8::operator ==(const char* Str)
	{
		return (*pImpl) == Str;
	};

	bool SonikStringUTF8::operator ==(const char16_t* w_Str)
	{
		return (*pImpl) == w_Str;
	};

	bool SonikStringUTF8::operator ==(const wchar_t* w_Str)
	{
		return (*pImpl) == w_Str;
	};

	bool SonikStringUTF8::operator ==(const char8_t* utf8_Str)
	{
