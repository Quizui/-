...
namespace SonikLib
{
	...
	public:
		//c:コンストラクタ
		SonikStringWIDE_pImpl(SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikStringWIDE_pImpl(const char* SetStr);
		SonikStringWIDE_pImpl(const char* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikStringWIDE_pImpl(const char16_t* SetStr);
		SonikStringWIDE_pImpl(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikStringWIDE_pImpl(const wchar_t* SetStr);
		SonikStringWIDE_pImpl(const wchar_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//コンストラクタオーバーロード
		SonikStringWIDE_pImpl(const char8_t* SetStr);
		SonikStringWIDE_pImpl(const char8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//コンストラクタオーバーロード
        SonikStringWIDE_pImpl(const int8_t SetValue);
		SonikStringWIDE_pImpl(const int8_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringWIDE_pImpl(const uint8_t SetValue);
		SonikStringWIDE_pImpl(const uint8_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringWIDE_pImpl(const int16_t SetValue);
		SonikStringWIDE_pImpl(const int16_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringWIDE_pImpl(const uint16_t SetValue);
		SonikStringWIDE_pImpl(const uint16_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringWIDE_pImpl(const int32_t SetValue);
		SonikStringWIDE_pImpl(const int32_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringWIDE_pImpl(const uint32_t SetValue);
		SonikStringWIDE_pImpl(const uint32_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringWIDE_pImpl(const int64_t SetValue);
		SonikStringWIDE_pImpl(const int64_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringWIDE_pImpl(const uint64_t SetValue);
		SonikStringWIDE_pImpl(const uint64_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringWIDE_pImpl(const float SetValue);
		SonikStringWIDE_pImpl(const float SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
        SonikStringWIDE_pImpl(const double SetValue);
		SonikStringWIDE_pImpl(const double SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);

		//c:コピーコンストラクタ
		SonikStringWIDE_pImpl(const SonikStringWIDE_pImpl& t_his);

		//c:デストラクタ
		~SonikStringWIDE_pImpl(void);
		...
		bool SplitForUTF8(char8_t delim, SonikLib::Container::SonikVariableArrayContainer<SonikLib::SonikStringWIDE>& Container);

		//c: 各入力フォーマットから現在のバッファに変換して代入します。
		SonikStringWIDE_pImpl& operator =(const SonikStringWIDE_pImpl& t_his);
		SonikStringWIDE_pImpl& operator =(SonikStringWIDE_pImpl&& Move) noexcept;
		SonikStringWIDE_pImpl& operator =(const char* Str);
		SonikStringWIDE_pImpl& operator =(const char16_t* w_Str);
		SonikStringWIDE_pImpl& operator =(const wchar_t* w_Str);
		SonikStringWIDE_pImpl& operator =(const char8_t* utf8_Str);
        SonikStringWIDE_pImpl& operator =(const int8_t SetValue);
        SonikStringWIDE_pImpl& operator =(const uint8_t SetValue);
        SonikStringWIDE_pImpl& operator =(const int16_t SetValue);
        SonikStringWIDE_pImpl& operator =(const uint16_t SetValue);
        SonikStringWIDE_pImpl& operator =(const int32_t SetValue);
        SonikStringWIDE_pImpl& operator =(const uint32_t SetValue);
        SonikStringWIDE_pImpl& operator =(const int64_t SetValue);
        SonikStringWIDE_pImpl& operator =(const uint64_t SetValue);
        SonikStringWIDE_pImpl& operator =(const float SetValue);
		SonikStringWIDE_pImpl& operator =(const double SetValue);
		...
		bool operator ==(const SonikStringWIDE_pImpl& t_his) ;
	...
	SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	...
	SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const char* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
	...
	SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const char* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
	...
	SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const char16_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const wchar_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	...
	SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const wchar_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UNKNOWN)
	...
	SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const char8_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const char8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const int8_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const int8_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const uint8_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const uint8_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const int16_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const int16_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const uint16_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const uint16_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const int32_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const int32_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const uint32_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const uint32_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const int64_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const int64_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const uint64_t SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const uint64_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const float SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const float SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const double SetValue)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const double SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
    :Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
	...
	SonikStringWIDE::SonikStringWIDE_pImpl::SonikStringWIDE_pImpl(const SonikStringWIDE_pImpl& t_his)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikStringWIDE::SonikStringWIDE_pImpl::~SonikStringWIDE_pImpl(void)
	{
		if(m_locale != 0)
		{
			delete[] m_locale;
	...
	bool SonikStringWIDE::SonikStringWIDE_pImpl::SetCharacterType(SonikLibConvertType SetType)
	{
...
//		unsigned long bufsize_ = SonikLibStringConvert::GetStringLength(reinterpret_cast<char*>(Stringval_));
	...
	bool SonikStringWIDE::SonikStringWIDE_pImpl::ReAlloc(uint64_t ReArraySize)
	{
		char8_t* pTmp = 0;
	...
	//ロケールを設定します。
	bool SonikStringWIDE::SonikStringWIDE_pImpl::SetStringLocale(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
	...
	const char* SonikStringWIDE::SonikStringWIDE_pImpl::str_c(void)
	{
	...
	//wchar_t形式に変換して取得します。(バッファタイプも書き換わります。)
	const wchar_t* SonikStringWIDE::SonikStringWIDE_pImpl::str_wchar(void)
	{
		if( CType == SCHTYPE_UNKNOWN )
		{
			return L"";
	...
	const char16_t* SonikStringWIDE::SonikStringWIDE_pImpl::str_utf16(void)
	{
		if( CType == SCHTYPE_UNKNOWN )
		{
			return u"";
	...
	const char8_t* SonikStringWIDE::SonikStringWIDE_pImpl::str_utf8(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
	...
	uint64_t SonikStringWIDE::SonikStringWIDE_pImpl::GetCpy_str_c(char* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikStringWIDE::SonikStringWIDE_pImpl::GetCpy_str_wcstr(wchar_t* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikStringWIDE::SonikStringWIDE_pImpl::GetCpy_str_utf16(char16_t* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikStringWIDE::SonikStringWIDE_pImpl::GetCpy_str_utf8(char8_t* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	//c:文字列のByte数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikStringWIDE::SonikStringWIDE_pImpl::Count_Byte_NotNull(void)
	{
		return SonikLibStringConvert::GetStringLengthByte(reinterpret_cast<char*>(Stringval_));
	};

	//c:文字列数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikStringWIDE::SonikStringWIDE_pImpl::Count_Str_NotNull(void)
	{
		return MaxLength_;
	};

	//文字列中の全角英数字を半角英数字に変換します。
	bool SonikStringWIDE::SonikStringWIDE_pImpl::ConvertFWANtoHWAN(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return false;
	...
	bool SonikStringWIDE::SonikStringWIDE_pImpl::ConvertFWKNtoHWKN(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return false;
	...
	//c: 指定位置の文字を削除します。
	void SonikStringWIDE::SonikStringWIDE_pImpl::EraseChar(uint64_t ChrPoint)
	{
		this->str_utf8();
	...
	//c: 指定の開始位置から指定された文字数を削除します。
	void SonikStringWIDE::SonikStringWIDE_pImpl::EraseStr(uint64_t ChrStartPoint, uint64_t ChrEndPoint)
	{
		this->str_utf8();
	...
	bool SonikStringWIDE::SonikStringWIDE_pImpl::SplitForUTF8(char8_t delim, SonikLib::Container::SonikVariableArrayContainer<SonikLib::SonikStringWIDE>& Container)
	{
		this->str_utf8();
	...
	SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const SonikStringWIDE_pImpl& t_his)
	{
	...
	SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(SonikStringWIDE_pImpl&& Move) noexcept
	{
		if( this == &Move )
		{
			return (*this);
	...
	SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const char* Str)
	{
		if(Str == 0 )
		{
			return (*this);
	...
	SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const char16_t* w_Str)
	{
		if(w_Str == 0 )
		{
			return (*this);
	...
	SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const wchar_t* w_Str)
	{
		if(w_Str == 0 )
		{
			return (*this);
	...
	SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const char8_t* utf8_Str)
	{
		if(utf8_Str == nullptr )
		{
			return (*this);
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const int8_t SetValue)
	{
		string_operator_lock.lock();
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const uint8_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const int16_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const uint16_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const int32_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const uint32_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const int64_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const uint64_t SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const float SetValue)
    {
		string_operator_lock.lock();
    ...
    SonikStringWIDE::SonikStringWIDE_pImpl& SonikStringWIDE::SonikStringWIDE_pImpl::operator =(const double SetValue)
    {
		string_operator_lock.lock();
	...
	SonikStringWIDE::SonikStringWIDE_pImpl SonikStringWIDE::SonikStringWIDE_pImpl::operator +(const SonikStringWIDE_pImpl& t_his)
	{
		SonikStringWIDE_pImpl tmpStr = (*this);
	...
	//c: 文字列同士を比較します。(strcmp)
	//c: 一致の場合true 不一致の場合 falseを返却します。
	bool SonikStringWIDE::SonikStringWIDE_pImpl::operator ==(const SonikStringWIDE_pImpl& t_his)
	{
	...
	bool SonikStringWIDE::SonikStringWIDE_pImpl::operator ==(const char* Str)
	{
	...
	bool SonikStringWIDE::SonikStringWIDE_pImpl::operator ==(const char16_t* w_Str)
	{
		//c: 文字タイプが違えば相手と同じ文字タイプに変換
		if( CType != SCHTYPE_UTF16 )
		{
	...
	bool SonikStringWIDE::SonikStringWIDE_pImpl::operator ==(const wchar_t* w_Str)
	{
#if WCHAR_MAX <= 0xFFFFU
		uint32_t NULLSTR_SIZE = 2;
		using CONST_CHRTYPE = const char16_t*;
	...
	bool SonikStringWIDE::SonikStringWIDE_pImpl::operator ==(const char8_t* utf8_Str)
	{
	...
	//c:比較演算子
	bool SonikStringWIDE::SonikStringWIDE_pImpl::Greater(const char* CompareArg2val)
	{
		return strcmp(this->str_c(), CompareArg2val) > 0;
	};

	bool SonikStringWIDE::SonikStringWIDE_pImpl::Less(const char* CompareArg2val)
	{
		return strcmp(this->str_c(), CompareArg2val) < 0;
	};

	bool SonikStringWIDE::SonikStringWIDE_pImpl::GreaterEqual(const char* CompareArg2val)
	{
		return !(this->Less(CompareArg2val));
	};

	bool SonikStringWIDE::SonikStringWIDE_pImpl::LessEqual(const char* CompareArg2val)
	{
...
//===========================================================
	...
	SonikStringWIDE::SonikStringWIDE(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		...
		try
		{
			pImpl = new SonikStringWIDE_pImpl(_setlocale_);
		}catch(std::bad_alloc&)
		{
			delete pImpl;
			throw;
	...
	SonikStringWIDE::SonikStringWIDE(const SonikStringWIDE& t_his)
	{
		...
		try
		{
			pImpl = new SonikStringWIDE_pImpl(SonikLibStringConvert::SonikLibConvertLocale::LC_JPN);
			(*pImpl) = (*(t_his.pImpl));
		}catch(std::bad_alloc&)
		{
			delete pImpl;
	...
	SonikStringWIDE::SonikStringWIDE(const char8_t* SetStr)
	{
		pImpl = 0;
	...
	SonikStringWIDE::SonikStringWIDE(const char8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;
	...
	//ロケールを設定します。
	bool SonikStringWIDE::SetStringLocale(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		return pImpl->SetStringLocale(_setlocale_);
	};

	//SJIS形式に変換して取得します。(バッファタイプも書き換わります。)
	const char* SonikStringWIDE::str_c(void)
	{
		return pImpl->str_c();
	};

	//wchar_t形式に変換して取得します。(バッファタイプも書き換わります。)
	const wchar_t* SonikStringWIDE::str_wchar(void)
	{
		return pImpl->str_wchar();
	};

	//UTF16形式に変換して取得します。(バッファタイプも書き換わります。)
	const char16_t* SonikStringWIDE::str_utf16(void)
	{
		return pImpl->str_utf16();
	};

	//UTF8形式に変換して取得します。(バッファタイプも書き換わります。)
	const char8_t* SonikStringWIDE::str_utf8(void)
	{
	...
	//SJIS形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikStringWIDE::GetCpy_str_c(char* dstBuffer)
	{
	...
	//wchar_t形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikStringWIDE::GetCpy_str_wcstr(wchar_t* dstBuffer)
	{
	...
	//UTF16形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikStringWIDE::GetCpy_str_utf16(char16_t* dstBuffer)
	{
	...
	//UTF8形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikStringWIDE::GetCpy_str_utf8(char8_t* dstBuffer)
	{
	...
	//c:文字列のByte数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikStringWIDE::Count_Byte_NotNull(void)
	{
		return pImpl->Count_Byte_NotNull();
	};

	//c:文字列数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikStringWIDE::Count_Str_NotNull(void)
	{
		return pImpl->Count_Str_NotNull();
	};

	//文字列中の全角英数字を半角英数字に変換します。
	bool SonikStringWIDE::ConvertFWANtoHWAN(void)
	{
		return pImpl->ConvertFWANtoHWAN();
	};

	//文字列中の全角カナを半角カナに変換します。
	bool SonikStringWIDE::ConvertFWKNtoHWKN(void)
	{
		return pImpl->ConvertFWKNtoHWKN();
	};

	//c: 指定位置の文字を削除します。
	void SonikStringWIDE::EraseChar(uint64_t ChrPoint)
	{
		pImpl->EraseChar(ChrPoint);
	};

	//c: 指定の開始位置から指定された文字数を削除します。
	void SonikStringWIDE::EraseStr(uint64_t ChrStartPoint, uint64_t ChrEndPoint)
	{
	...
	SonikStringWIDE& SonikStringWIDE::operator =(const char8_t* utf8_Str)
	{
		(*pImpl) = utf8_Str;
	...
	//c: 文字列同士を比較します。(strcmp)
	//c: 一致の場合true 不一致の場合 falseを返却します。
	bool SonikStringWIDE::operator ==(const SonikStringWIDE& t_his)
	{
		return (*pImpl) == (*t_his.pImpl);
	};

	bool SonikStringWIDE::operator ==(const char* Str)
	{
		return (*pImpl) == Str;
	};

	bool SonikStringWIDE::operator ==(const char16_t* w_Str)
	{
		return (*pImpl) == w_Str;
	};

	bool SonikStringWIDE::operator ==(const wchar_t* w_Str)
	{
		return (*pImpl) == w_Str;
	};

	bool SonikStringWIDE::operator ==(const char8_t* utf8_Str)
	{
