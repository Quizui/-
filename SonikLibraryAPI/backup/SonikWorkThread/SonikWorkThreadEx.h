...
namespace SonikThread
{
	...
	public:
		...
		bool SetCallFunction(SonikLib::SonikAllocSmtPtr<SonikLib::FunctionSystem_Base> CallFunctionObject, bool DeleteFlag = true);
		...
		void Set_ExternalQueue(SonikQueue::SonikAtomicQueue<SonikLib::SonikAllocSmtPtr<SonikThreadPack::ThreadPack>>* pSetQueue);
