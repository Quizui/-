...
namespace SonikLib
{
	...
	class SonikString_UTF16::SonikString_UTF16_pImpl
	{
	private:
		//c:文字列領域
		int8_t* Stringval_;
	...
	public:
		//c:コンストラクタ
		SonikString_UTF16_pImpl(SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikString_UTF16_pImpl(const char* SetStr);
		SonikString_UTF16_pImpl(const char* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikString_UTF16_pImpl(const char16_t* SetStr);
		SonikString_UTF16_pImpl(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikString_UTF16_pImpl(const wchar_t* SetStr);
		SonikString_UTF16_pImpl(const wchar_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//コンストラクタオーバーロード
		SonikString_UTF16_pImpl(const int8_t* SetStr);
		SonikString_UTF16_pImpl(const int8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);

		//c:コピーコンストラクタ
		SonikString_UTF16_pImpl(const SonikString_UTF16_pImpl& t_his);

		//c:デストラクタ
		~SonikString_UTF16_pImpl(void);
		...
		SonikString_UTF16_pImpl& operator =(const SonikString_UTF16_pImpl& t_his);
		SonikString_UTF16_pImpl& operator =(SonikString_UTF16_pImpl&& Move) noexcept;
		SonikString_UTF16_pImpl& operator =(const char* Str);
		SonikString_UTF16_pImpl& operator =(const char16_t* w_Str);
		SonikString_UTF16_pImpl& operator =(const wchar_t* w_Str);
		SonikString_UTF16_pImpl& operator =(const int8_t* utf8_Str);
		...
		bool operator ==(const SonikString_UTF16_pImpl& t_his) ;
	...
	SonikString_UTF16::SonikString_UTF16_pImpl::SonikString_UTF16_pImpl(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	...
	SonikString_UTF16::SonikString_UTF16_pImpl::SonikString_UTF16_pImpl(const char* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
	...
	SonikString_UTF16::SonikString_UTF16_pImpl::SonikString_UTF16_pImpl(const char* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
	...
	SonikString_UTF16::SonikString_UTF16_pImpl::SonikString_UTF16_pImpl(const char16_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikString_UTF16::SonikString_UTF16_pImpl::SonikString_UTF16_pImpl(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikString_UTF16::SonikString_UTF16_pImpl::SonikString_UTF16_pImpl(const wchar_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikString_UTF16::SonikString_UTF16_pImpl::SonikString_UTF16_pImpl(const wchar_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikString_UTF16::SonikString_UTF16_pImpl::SonikString_UTF16_pImpl(const int8_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikString_UTF16::SonikString_UTF16_pImpl::SonikString_UTF16_pImpl(const int8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikString_UTF16::SonikString_UTF16_pImpl::SonikString_UTF16_pImpl(const SonikString_UTF16_pImpl& t_his)
	{
	...
	SonikString_UTF16::SonikString_UTF16_pImpl::~SonikString_UTF16_pImpl(void)
	{
		if(m_locale != 0)
		{
			delete[] m_locale;
	...
	bool SonikString_UTF16::SonikString_UTF16_pImpl::SetCharacterType(SonikLibConvertType SetType)
	{
...
//				};
	...
	bool SonikString_UTF16::SonikString_UTF16_pImpl::ReAlloc(uint64_t ReArraySize)
	{
		int8_t* pTmp = 0;
	...
	//ロケールを設定します。
	bool SonikString_UTF16::SonikString_UTF16_pImpl::SetStringLocale(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
	...
	const char* SonikString_UTF16::SonikString_UTF16_pImpl::c_str(void)
	{
	...
	const char16_t* SonikString_UTF16::SonikString_UTF16_pImpl::c_wcstr(void)
	{
		if( CType == SCHTYPE_UNKNOWN )
		{
			return u"";
	...
	const int8_t* SonikString_UTF16::SonikString_UTF16_pImpl::utf8_str(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
	...
	uint64_t SonikString_UTF16::SonikString_UTF16_pImpl::GetCpy_c_str(char* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikString_UTF16::SonikString_UTF16_pImpl::GetCpy_c_wcstr(char16_t* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikString_UTF16::SonikString_UTF16_pImpl::GetCpy_c_wcstr(wchar_t* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikString_UTF16::SonikString_UTF16_pImpl::GetCpy_utf8_str(char* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	//c:文字列のByte数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikString_UTF16::SonikString_UTF16_pImpl::Count_Byte_NotNull(void)
	{
		return SonikLibStringConvert::GetStringLengthByte(reinterpret_cast<char*>(Stringval_));
	};

	//c:文字列数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikString_UTF16::SonikString_UTF16_pImpl::Count_Str_NotNull(void)
	{
		return MaxLength_;
	};

	//文字列中の全角英数字を半角英数字に変換します。
	bool SonikString_UTF16::SonikString_UTF16_pImpl::ConvertFWANtoHWAN(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return false;
	...
	bool SonikString_UTF16::SonikString_UTF16_pImpl::ConvertFWKNtoHWKN(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return false;
	...
	//c: 指定位置の文字を削除します。
	void SonikString_UTF16::SonikString_UTF16_pImpl::EraseChar(uint64_t ChrPoint)
	{
		this->utf8_str();
	...
	//c: 指定の開始位置から指定された文字数を削除します。
	void SonikString_UTF16::SonikString_UTF16_pImpl::EraseStr(uint64_t ChrStartPoint, uint64_t ChrEndPoint)
	{
		this->utf8_str();
	...
	bool SonikString_UTF16::SonikString_UTF16_pImpl::SplitForUTF8(uint8_t delim, SonikLib::SonikVariableArrayContainer<SonikLib::SonikString_UTF16>& Container)
	{
		this->utf8_str();
		...
		SonikLib::SonikString_UTF16 PushStr;
		while( (*pTmpstr) != 0x00 )
		{
	...
	SonikString_UTF16::SonikString_UTF16_pImpl& SonikString_UTF16::SonikString_UTF16_pImpl::operator =(const SonikString_UTF16_pImpl& t_his)
	{
	...
	SonikString_UTF16::SonikString_UTF16_pImpl& SonikString_UTF16::SonikString_UTF16_pImpl::operator =(SonikString_UTF16_pImpl&& Move) noexcept
	{
		if( this == &Move )
		{
			return (*this);
	...
	SonikString_UTF16::SonikString_UTF16_pImpl& SonikString_UTF16::SonikString_UTF16_pImpl::operator =(const char* Str)
	{
		if(Str == 0 )
		{
			return (*this);
	...
	SonikString_UTF16::SonikString_UTF16_pImpl& SonikString_UTF16::SonikString_UTF16_pImpl::operator =(const char16_t* w_Str)
	{
		if(w_Str == 0 )
		{
			return (*this);
	...
	SonikString_UTF16::SonikString_UTF16_pImpl& SonikString_UTF16::SonikString_UTF16_pImpl::operator =(const wchar_t* w_Str)
	{
		if(w_Str == 0 )
		{
			return (*this);
	...
	SonikString_UTF16::SonikString_UTF16_pImpl& SonikString_UTF16::SonikString_UTF16_pImpl::operator =(const int8_t* utf8_Str)
	{
		if(utf8_Str == nullptr )
		{
			return (*this);
	...
	SonikString_UTF16::SonikString_UTF16_pImpl SonikString_UTF16::SonikString_UTF16_pImpl::operator +(const SonikString_UTF16_pImpl& t_his)
	{
		SonikString_UTF16_pImpl tmpStr = (*this);
	...
	//c: 文字列同士を比較します。(strcmp)
	//c: 一致の場合true 不一致の場合 falseを返却します。
	bool SonikString_UTF16::SonikString_UTF16_pImpl::operator ==(const SonikString_UTF16_pImpl& t_his)
	{
	...
	bool SonikString_UTF16::SonikString_UTF16_pImpl::operator ==(const char* Str)
	{
	...
	bool SonikString_UTF16::SonikString_UTF16_pImpl::operator ==(const char16_t* w_Str)
	{
		//c: 文字タイプが違えば相手と同じ文字タイプに変換
		if( CType != SCHTYPE_UTF16 )
		{
	...
	bool SonikString_UTF16::SonikString_UTF16_pImpl::operator ==(const wchar_t* w_Str)
	{
		//c: 文字タイプが違えば相手と同じ文字タイプに変換
		if( CType != SCHTYPE_UTF16 )
		{
	...
	bool SonikString_UTF16::SonikString_UTF16_pImpl::operator ==(const int8_t* utf8_Str)
	{
	...
	//c:比較演算子
	bool SonikString_UTF16::SonikString_UTF16_pImpl::Greater(const char* CompareArg2val)
	{
	...
	bool SonikString_UTF16::SonikString_UTF16_pImpl::Less(const char* CompareArg2val)
	{
		return this->Greater(CompareArg2val);
	};

	bool SonikString_UTF16::SonikString_UTF16_pImpl::GreaterEqual(const char* CompareArg2val)
	{
		return !(this->Less(CompareArg2val));
	};

	bool SonikString_UTF16::SonikString_UTF16_pImpl::LessEqual(const char* CompareArg2val)
	{
		return !(this->Greater(CompareArg2val));
	};
...
//===========================================================
	...
	SonikString_UTF16::SonikString_UTF16(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;

		try
		{
			pImpl = new SonikString_UTF16_pImpl(_setlocale_);
		}catch(std::bad_alloc&)
		{
			delete pImpl;
			throw;
	...
	SonikString_UTF16::SonikString_UTF16(const SonikString_UTF16& t_his)
	{
		pImpl = nullptr;

		try
		{
			pImpl = new SonikString_UTF16_pImpl(SonikLibStringConvert::SonikLibConvertLocale::LC_DEFAULT_C);
			(*pImpl) = (*(t_his.pImpl));
		}catch(std::bad_alloc&)
		{
			delete pImpl;
	...
	SonikString_UTF16::SonikString_UTF16(const char* SetStr)
	{
		pImpl = nullptr;
	...
	SonikString_UTF16::SonikString_UTF16(const char* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;
	...
	SonikString_UTF16::SonikString_UTF16(const char16_t* SetStr)
	{
		pImpl = 0;
	...
	SonikString_UTF16::SonikString_UTF16(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;
	...
	SonikString_UTF16::SonikString_UTF16(const wchar_t* SetStr)
	{
		pImpl = 0;
	...
	SonikString_UTF16::SonikString_UTF16(const wchar_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;
	...
	SonikString_UTF16::SonikString_UTF16(const int8_t* SetStr)
	{
		pImpl = 0;
	...
	SonikString_UTF16::SonikString_UTF16(const int8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;
	...
	SonikString_UTF16::~SonikString_UTF16(void)
	{
		if(pImpl != 0)
		{
			delete pImpl;
	...
	//ロケールを設定します。
	bool SonikString_UTF16::SetStringLocale(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		return pImpl->SetStringLocale(_setlocale_);
	};

	//SJIS形式に変換して取得します。(バッファタイプも書き換わります。)
	const char* SonikString_UTF16::c_str(void)
	{
		return pImpl->c_str();
	};

	//UTF16形式に変換して取得します。(バッファタイプも書き換わります。)
	const char16_t* SonikString_UTF16::c_wcstr(void)
	{
		return pImpl->c_wcstr();
	};

	//UTF8形式に変換して取得します。(バッファタイプも書き換わります。)
	const int8_t* SonikString_UTF16::utf8_str(void)
	{
		return pImpl->utf8_str();
	};

	//define切り替えのstrゲット
	const char* SonikString_UTF16::definition_str(void)
	{
		return pImpl->c_str();
	};
	...
	uint64_t SonikString_UTF16::GetCpy_c_str(char* dstBuffer)
	{
	...
	//UTF16形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikString_UTF16::GetCpy_utf16_str(char16_t* dstBuffer)
	{
	...
	//UTF16形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikString_UTF16::GetCpy_c_wcstr(wchar_t* dstBuffer)
	{
		return pImpl->GetCpy_c_wcstr(dstBuffer);
	};
	...
	//UTF8形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikString_UTF16::GetCpy_utf8_str(char* dstBuffer)
	{
		return pImpl->GetCpy_utf8_str(dstBuffer);
	};

	//c:文字列のByte数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikString_UTF16::Count_Byte_NotNull(void)
	{
		return pImpl->Count_Byte_NotNull();
	};

	//c:文字列数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikString_UTF16::Count_Str_NotNull(void)
	{
		return pImpl->Count_Str_NotNull();
	};

	//文字列中の全角英数字を半角英数字に変換します。
	bool SonikString_UTF16::ConvertFWANtoHWAN(void)
	{
		return pImpl->ConvertFWANtoHWAN();
	};

	//文字列中の全角カナを半角カナに変換します。
	bool SonikString_UTF16::ConvertFWKNtoHWKN(void)
	{
		return pImpl->ConvertFWKNtoHWKN();
	};

	//c: 指定位置の文字を削除します。
	void SonikString_UTF16::EraseChar(uint64_t ChrPoint)
	{
		pImpl->EraseChar(ChrPoint);
	};

	//c: 指定の開始位置から指定された文字数を削除します。
	void SonikString_UTF16::EraseStr(uint64_t ChrStartPoint, uint64_t ChrEndPoint)
	{
		pImpl->EraseStr(ChrStartPoint, ChrEndPoint);
	};

	//指定したAsciiコードをデリミタとしてSplitを行います。
	bool SonikString_UTF16::SplitForUTF8(uint8_t delim, SonikLib::SonikVariableArrayContainer<SonikLib::SonikString_UTF16>& Container)
	{
		return pImpl->SplitForUTF8(delim, Container);
	};

	//各入力フォーマットから現在のバッファに変換して代入します。
	SonikString_UTF16& SonikString_UTF16::operator =(const SonikString_UTF16& t_his)
	{
		(*pImpl) = (*(t_his.pImpl));
	...
	SonikString_UTF16& SonikString_UTF16::operator =(SonikString_UTF16&& Move) noexcept
	{
	...
	SonikString_UTF16& SonikString_UTF16::operator =(const char* Str)
	{
		(*pImpl) = Str;
	...
	SonikString_UTF16& SonikString_UTF16::operator =(const char16_t* w_Str)
	{
		(*pImpl) = w_Str;
	...
	SonikString_UTF16& SonikString_UTF16::operator =(const wchar_t* w_Str)
	{
		(*pImpl) = w_Str;
	...
	SonikString_UTF16& SonikString_UTF16::operator =(const int8_t* utf8_Str)
	{
		(*pImpl) = utf8_Str;
	...
	//c: 文字列同士を比較します。(strcmp)
	//c: 一致の場合true 不一致の場合 falseを返却します。
	bool SonikString_UTF16::operator ==(const SonikString_UTF16& t_his)
	{
		return (*pImpl) == (*t_his.pImpl);
	};

	bool SonikString_UTF16::operator ==(const char* Str)
	{
		return (*pImpl) == Str;
	};

	bool SonikString_UTF16::operator ==(const char16_t* w_Str)
	{
		return (*pImpl) == w_Str;
	};

	bool SonikString_UTF16::operator ==(const wchar_t* w_Str)
	{
		return (*pImpl) == w_Str;
	};

	bool SonikString_UTF16::operator ==(const int8_t* utf8_Str)
	{
		return (*pImpl) == utf8_Str;
	};
