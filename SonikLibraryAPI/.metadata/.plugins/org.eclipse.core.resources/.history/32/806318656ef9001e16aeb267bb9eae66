...
namespace SonikLib
{
	...
	public:
		//c:コンストラクタ
		SonikString_CHR32_pImpl(SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikString_CHR32_pImpl(const char* SetStr);
		SonikString_CHR32_pImpl(const char* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikString_CHR32_pImpl(const char16_t* SetStr);
		SonikString_CHR32_pImpl(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//c:コンストラクタオーバーロード
		SonikString_CHR32_pImpl(const wchar_t* SetStr);
		SonikString_CHR32_pImpl(const wchar_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		//コンストラクタオーバーロード
		SonikString_CHR32_pImpl(const int8_t* SetStr);
		SonikString_CHR32_pImpl(const int8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);

		//c:コピーコンストラクタ
		SonikString_CHR32_pImpl(const SonikString_CHR32_pImpl& t_his);

		//c:デストラクタ
		~SonikString_CHR32_pImpl(void);
		...
		bool SplitForUTF8(uint8_t delim, SonikLib::Container::SonikVariableArrayContainer<SonikLib::SonikString_CHR32>& Container);

		//c: 各入力フォーマットから現在のバッファに変換して代入します。
		SonikString_CHR32_pImpl& operator =(const SonikString_CHR32_pImpl& t_his);
		SonikString_CHR32_pImpl& operator =(SonikString_CHR32_pImpl&& Move) noexcept;
		SonikString_CHR32_pImpl& operator =(const char* Str);
		SonikString_CHR32_pImpl& operator =(const char16_t* w_Str);
		SonikString_CHR32_pImpl& operator =(const wchar_t* w_Str);
		SonikString_CHR32_pImpl& operator =(const int8_t* utf8_Str);
		...
		bool operator ==(const SonikString_CHR32_pImpl& t_his) ;
	...
	SonikString_CHR32::SonikString_CHR32_pImpl::SonikString_CHR32_pImpl(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	...
	SonikString_CHR32::SonikString_CHR32_pImpl::SonikString_CHR32_pImpl(const char* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
	...
	SonikString_CHR32::SonikString_CHR32_pImpl::SonikString_CHR32_pImpl(const char* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_NULLTEXT)
	...
	SonikString_CHR32::SonikString_CHR32_pImpl::SonikString_CHR32_pImpl(const char16_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikString_CHR32::SonikString_CHR32_pImpl::SonikString_CHR32_pImpl(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikString_CHR32::SonikString_CHR32_pImpl::SonikString_CHR32_pImpl(const wchar_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF32)
	...
	SonikString_CHR32::SonikString_CHR32_pImpl::SonikString_CHR32_pImpl(const wchar_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF32)
	...
	SonikString_CHR32::SonikString_CHR32_pImpl::SonikString_CHR32_pImpl(const int8_t* SetStr)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikString_CHR32::SonikString_CHR32_pImpl::SonikString_CHR32_pImpl(const int8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	...
	SonikString_CHR32::SonikString_CHR32_pImpl::SonikString_CHR32_pImpl(const SonikString_CHR32_pImpl& t_his)
	:Stringval_(nullptr)
	,m_locale(nullptr)
	,MaxLength_(0)
	,CType(SCHTYPE_UTF16)
	,buffer_(100)
{
	...
	SonikString_CHR32::SonikString_CHR32_pImpl::~SonikString_CHR32_pImpl(void)
	{
		if(m_locale != 0)
		{
			delete[] m_locale;
	...
	bool SonikString_CHR32::SonikString_CHR32_pImpl::SetCharacterType(SonikLibConvertType SetType)
	{
...
//				};
	...
	bool SonikString_CHR32::SonikString_CHR32_pImpl::ReAlloc(uint64_t ReArraySize)
	{
		int8_t* pTmp = 0;
	...
	//ロケールを設定します。
	bool SonikString_CHR32::SonikString_CHR32_pImpl::SetStringLocale(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
	...
	const char* SonikString_CHR32::SonikString_CHR32_pImpl::str_c(void)
	{
	...
	//wchar_t形式に変換して取得します。(バッファタイプも書き換わります。)
	const wchar_t* SonikString_CHR32::SonikString_CHR32_pImpl::str_wchar(void)
	{
		if( CType == SCHTYPE_UNKNOWN )
		{
			return u"";
	...
	const char16_t* SonikString_CHR32::SonikString_CHR32_pImpl::str_utf16(void)
	{
		if( CType == SCHTYPE_UNKNOWN )
		{
			return u"";
	...
	const int8_t* SonikString_CHR32::SonikString_CHR32_pImpl::str_utf8(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
	...
	uint64_t SonikString_CHR32::SonikString_CHR32_pImpl::GetCpy_str_c(char* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikString_CHR32::SonikString_CHR32_pImpl::GetCpy_str_wcstr(wchar_t* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikString_CHR32::SonikString_CHR32_pImpl::GetCpy_str_utf16(char16_t* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	uint64_t SonikString_CHR32::SonikString_CHR32_pImpl::GetCpy_str_utf8(char* dstBuffer)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return 0;
	...
	//c:文字列のByte数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikString_CHR32::SonikString_CHR32_pImpl::Count_Byte_NotNull(void)
	{
		return SonikLibStringConvert::GetStringLengthByte(reinterpret_cast<char*>(Stringval_));
	};

	//c:文字列数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikString_CHR32::SonikString_CHR32_pImpl::Count_Str_NotNull(void)
	{
		return MaxLength_;
	};

	//文字列中の全角英数字を半角英数字に変換します。
	bool SonikString_CHR32::SonikString_CHR32_pImpl::ConvertFWANtoHWAN(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return false;
	...
	bool SonikString_CHR32::SonikString_CHR32_pImpl::ConvertFWKNtoHWKN(void)
	{
		if(CType == SCHTYPE_UNKNOWN)
		{
			return false;
	...
	//c: 指定位置の文字を削除します。
	void SonikString_CHR32::SonikString_CHR32_pImpl::EraseChar(uint64_t ChrPoint)
	{
		this->str_utf8();
	...
	//c: 指定の開始位置から指定された文字数を削除します。
	void SonikString_CHR32::SonikString_CHR32_pImpl::EraseStr(uint64_t ChrStartPoint, uint64_t ChrEndPoint)
	{
		this->str_utf8();
	...
	bool SonikString_CHR32::SonikString_CHR32_pImpl::SplitForUTF8(uint8_t delim, SonikLib::Container::SonikVariableArrayContainer<SonikLib::SonikString_CHR32>& Container)
	{
		this->str_utf8();
		...
		SonikLib::SonikString_CHR32 PushStr;
		while( (*pTmpstr) != 0x00 )
		{
	...
	SonikString_CHR32::SonikString_CHR32_pImpl& SonikString_CHR32::SonikString_CHR32_pImpl::operator =(const SonikString_CHR32_pImpl& t_his)
	{
	...
	SonikString_CHR32::SonikString_CHR32_pImpl& SonikString_CHR32::SonikString_CHR32_pImpl::operator =(SonikString_CHR32_pImpl&& Move) noexcept
	{
		if( this == &Move )
		{
			return (*this);
	...
	SonikString_CHR32::SonikString_CHR32_pImpl& SonikString_CHR32::SonikString_CHR32_pImpl::operator =(const char* Str)
	{
		if(Str == 0 )
		{
			return (*this);
	...
	SonikString_CHR32::SonikString_CHR32_pImpl& SonikString_CHR32::SonikString_CHR32_pImpl::operator =(const char16_t* w_Str)
	{
		if(w_Str == 0 )
		{
			return (*this);
	...
	SonikString_CHR32::SonikString_CHR32_pImpl& SonikString_CHR32::SonikString_CHR32_pImpl::operator =(const wchar_t* w_Str)
	{
		if(w_Str == 0 )
		{
			return (*this);
	...
	SonikString_CHR32::SonikString_CHR32_pImpl& SonikString_CHR32::SonikString_CHR32_pImpl::operator =(const int8_t* utf8_Str)
	{
		if(utf8_Str == nullptr )
		{
			return (*this);
	...
	SonikString_CHR32::SonikString_CHR32_pImpl SonikString_CHR32::SonikString_CHR32_pImpl::operator +(const SonikString_CHR32_pImpl& t_his)
	{
		SonikString_CHR32_pImpl tmpStr = (*this);
	...
	//c: 文字列同士を比較します。(strcmp)
	//c: 一致の場合true 不一致の場合 falseを返却します。
	bool SonikString_CHR32::SonikString_CHR32_pImpl::operator ==(const SonikString_CHR32_pImpl& t_his)
	{
	...
	bool SonikString_CHR32::SonikString_CHR32_pImpl::operator ==(const char* Str)
	{
	...
	bool SonikString_CHR32::SonikString_CHR32_pImpl::operator ==(const char16_t* w_Str)
	{
		//c: 文字タイプが違えば相手と同じ文字タイプに変換
		if( CType != SCHTYPE_UTF16 )
		{
	...
	bool SonikString_CHR32::SonikString_CHR32_pImpl::operator ==(const wchar_t* w_Str)
	{
		//c: 文字タイプが違えば相手と同じ文字タイプに変換
		if( CType != SCHTYPE_UTF16 )
		{
	...
	bool SonikString_CHR32::SonikString_CHR32_pImpl::operator ==(const int8_t* utf8_Str)
	{
	...
	//c:比較演算子
	bool SonikString_CHR32::SonikString_CHR32_pImpl::Greater(const char* CompareArg2val)
	{
	...
	bool SonikString_CHR32::SonikString_CHR32_pImpl::Less(const char* CompareArg2val)
	{
		return this->Greater(CompareArg2val);
	};

	bool SonikString_CHR32::SonikString_CHR32_pImpl::GreaterEqual(const char* CompareArg2val)
	{
		return !(this->Less(CompareArg2val));
	};

	bool SonikString_CHR32::SonikString_CHR32_pImpl::LessEqual(const char* CompareArg2val)
	{
		return !(this->Greater(CompareArg2val));
	};
...
//===========================================================
	...
	SonikString_CHR32::SonikString_CHR32(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;

		try
		{
			pImpl = new SonikString_CHR32_pImpl(_setlocale_);
		}catch(std::bad_alloc&)
		{
			delete pImpl;
			throw;
	...
	SonikString_CHR32::SonikString_CHR32(const SonikString_CHR32& t_his)
	{
		pImpl = nullptr;

		try
		{
			pImpl = new SonikString_CHR32_pImpl(SonikLibStringConvert::SonikLibConvertLocale::LC_JPN);
			(*pImpl) = (*(t_his.pImpl));
		}catch(std::bad_alloc&)
		{
			delete pImpl;
	...
	SonikString_CHR32::SonikString_CHR32(const char* SetStr)
	{
		pImpl = nullptr;
	...
	SonikString_CHR32::SonikString_CHR32(const char* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;
	...
	SonikString_CHR32::SonikString_CHR32(const char16_t* SetStr)
	{
		pImpl = 0;
	...
	SonikString_CHR32::SonikString_CHR32(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;
	...
	SonikString_CHR32::SonikString_CHR32(const wchar_t* SetStr)
	{
		pImpl = 0;
	...
	SonikString_CHR32::SonikString_CHR32(const wchar_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;
	...
	SonikString_CHR32::SonikString_CHR32(const int8_t* SetStr)
	{
		pImpl = 0;
	...
	SonikString_CHR32::SonikString_CHR32(const int8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		pImpl = nullptr;
	...
	SonikString_CHR32::~SonikString_CHR32(void)
	{
		if(pImpl != 0)
		{
			delete pImpl;
	...
	//ロケールを設定します。
	bool SonikString_CHR32::SetStringLocale(SonikLibStringConvert::SonikLibConvertLocale _setlocale_)
	{
		return pImpl->SetStringLocale(_setlocale_);
	};

	//SJIS形式に変換して取得します。(バッファタイプも書き換わります。)
	const char* SonikString_CHR32::str_c(void)
	{
		return pImpl->str_c();
	};

	//wchar_t形式に変換して取得します。(バッファタイプも書き換わります。)
	const wchar_t* SonikString_CHR32::str_wchar(void)
	{
		return pImpl->str_wchar();
	};

	//UTF16形式に変換して取得します。(バッファタイプも書き換わります。)
	const char16_t* SonikString_CHR32::str_utf16(void)
	{
		return pImpl->str_utf16();
	};

	//UTF8形式に変換して取得します。(バッファタイプも書き換わります。)
	const int8_t* SonikString_CHR32::str_utf8(void)
	{
		return pImpl->str_utf8();
	};

	//define切り替えのstrゲット
	const char* SonikString_CHR32::definition_str(void)
	{
		return pImpl->str_c();
	};
	...
	//SJIS形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikString_CHR32::GetCpy_str_c(char* dstBuffer)
	{
	...
	//wchar_t形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikString_CHR32::GetCpy_str_wcstr(wchar_t* dstBuffer)
	{
	...
	//UTF16形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikString_CHR32::GetCpy_str_utf16(char16_t* dstBuffer)
	{
	...
	//UTF8形式に変換して、バッファをdstBufferにコピーします。(バッファタイプも書き換わります。)
	//第１引数を省略してコールした場合はdstに必要なバッファサイズを取得することができます。(単位/1Byte)
	uint64_t SonikString_CHR32::GetCpy_str_utf8(char* dstBuffer)
	{
		return pImpl->GetCpy_str_utf8(dstBuffer);
	};

	//c:文字列のByte数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikString_CHR32::Count_Byte_NotNull(void)
	{
		return pImpl->Count_Byte_NotNull();
	};

	//c:文字列数を取得します。（Null終端文字をカウントに含まない)
	uint64_t SonikString_CHR32::Count_Str_NotNull(void)
	{
		return pImpl->Count_Str_NotNull();
	};

	//文字列中の全角英数字を半角英数字に変換します。
	bool SonikString_CHR32::ConvertFWANtoHWAN(void)
	{
		return pImpl->ConvertFWANtoHWAN();
	};

	//文字列中の全角カナを半角カナに変換します。
	bool SonikString_CHR32::ConvertFWKNtoHWKN(void)
	{
		return pImpl->ConvertFWKNtoHWKN();
	};

	//c: 指定位置の文字を削除します。
	void SonikString_CHR32::EraseChar(uint64_t ChrPoint)
	{
		pImpl->EraseChar(ChrPoint);
	};

	//c: 指定の開始位置から指定された文字数を削除します。
	void SonikString_CHR32::EraseStr(uint64_t ChrStartPoint, uint64_t ChrEndPoint)
	{
		pImpl->EraseStr(ChrStartPoint, ChrEndPoint);
	};

	//指定したAsciiコードをデリミタとしてSplitを行います。
	bool SonikString_CHR32::SplitForUTF8(uint8_t delim, SonikLib::Container::SonikVariableArrayContainer<SonikLib::SonikString_CHR32>& Container)
	{
		return pImpl->SplitForUTF8(delim, Container);
	};

	//各入力フォーマットから現在のバッファに変換して代入します。
	SonikString_CHR32& SonikString_CHR32::operator =(const SonikString_CHR32& t_his)
	{
		(*pImpl) = (*(t_his.pImpl));
	...
	SonikString_CHR32& SonikString_CHR32::operator =(SonikString_CHR32&& Move) noexcept
	{
	...
	SonikString_CHR32& SonikString_CHR32::operator =(const char* Str)
	{
		(*pImpl) = Str;
	...
	SonikString_CHR32& SonikString_CHR32::operator =(const char16_t* w_Str)
	{
		(*pImpl) = w_Str;
	...
	SonikString_CHR32& SonikString_CHR32::operator =(const wchar_t* w_Str)
	{
		(*pImpl) = w_Str;
	...
	SonikString_CHR32& SonikString_CHR32::operator =(const int8_t* utf8_Str)
	{
		(*pImpl) = utf8_Str;
	...
	//c: 文字列同士を比較します。(strcmp)
	//c: 一致の場合true 不一致の場合 falseを返却します。
	bool SonikString_CHR32::operator ==(const SonikString_CHR32& t_his)
	{
		return (*pImpl) == (*t_his.pImpl);
	};

	bool SonikString_CHR32::operator ==(const char* Str)
	{
		return (*pImpl) == Str;
	};

	bool SonikString_CHR32::operator ==(const char16_t* w_Str)
	{
		return (*pImpl) == w_Str;
	};

	bool SonikString_CHR32::operator ==(const wchar_t* w_Str)
	{
		return (*pImpl) == w_Str;
	};

	bool SonikString_CHR32::operator ==(const int8_t* utf8_Str)
	{
	...
	bool operator <(const SonikString_CHR32& CompareArg1val, const SonikString_CHR32& CompareArg2val)
	{
