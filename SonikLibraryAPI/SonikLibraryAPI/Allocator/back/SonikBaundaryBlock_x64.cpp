...
namespace SonikBaundaryBlock
{
	...
	uint64_t SonikBaundaryPre::GetGoPostTagSize(void)
	{
		return ( sizeof(SonikBaundaryPre) + UseUserMemorySize );
	};

	//���݂̉^�p������(���[�U�[�g�p������)�T�C�Y���擾����B
	uint64_t SonikBaundaryPre::GetUseMemorySize(void)
	{
		return UseUserMemorySize;
	};

	//���݂̈ʒu�����u�^�O���܂ނ��ׂẴT�C�Y���擾����B
	uint64_t SonikBaundaryPre::GetAllDataSize(void)
	{
	...
	void SonikBaundaryPre::SetUseUserMemorySize(uint64_t SetSize)
	{
