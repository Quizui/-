...
AudioLoadFunction/Functions/%.o: ../AudioLoadFunction/Functions/%.cpp AudioLoadFunction/Functions/subdir.mk
	...
	clang++ -std=c++20 -D_RELEASE -D__cplusplus=202002L -D__SONIK_x86_64__=1 -D_WIN64 -I"D:\MyLibrary\include\Audio\AudioFormat\LoadFunction" -O3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
