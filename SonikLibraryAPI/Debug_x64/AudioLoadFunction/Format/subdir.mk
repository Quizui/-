...
AudioLoadFunction/Format/%.o: ../AudioLoadFunction/Format/%.cpp AudioLoadFunction/Format/subdir.mk
	...
	clang++ -std=c++20 -D__SONIK_x86_64__=1 -D_DEBUG -D__cplusplus=202002L -D_WIN64 -I"D:\MyLibrary\include\Audio\AudioFormat\Format" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
